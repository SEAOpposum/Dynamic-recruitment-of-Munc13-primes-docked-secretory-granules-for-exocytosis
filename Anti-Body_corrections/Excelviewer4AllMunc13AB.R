...
m132r<-read_excel("E:/SubmissionM13 Paper/Revision Cell reports/M131vsM132/Exocytosis exp/Expression 250112/Align/Munc13abIn.xlsx", sheet = "1600_M13ab_Red")
m132g<-read_excel("E:/SubmissionM13 Paper/Revision Cell reports/M131vsM132/Exocytosis exp/Expression 250112/Align/Munc13abIn.xlsx", sheet = "1600_M13ab_Green")
m131r<-read_excel("E:/SubmissionM13 Paper/Revision Cell reports/M131vsM132/Exocytosis exp/Expression 250112/Align/Munc13abIn.xlsx", sheet = "1031_M13ab_Red")
m131g<-read_excel("E:/SubmissionM13 Paper/Revision Cell reports/M131vsM132/Exocytosis exp/Expression 250112/Align/Munc13abIn.xlsx", sheet = "1031_M13ab_Green")
m13n<-read_excel("E:/SubmissionM13 Paper/Revision Cell reports/M131vsM132/Exocytosis exp/Expression 250112/Align/Munc13abIn.xlsx", sheet = "M13ab_Red")

greenlaser=115*0.010
redlaser=107.9*0.010
...
plot(m131g$RedCorrection,m131g$GreenCorrection)#the upper limit is for the point where de data lost linearity 
...
plot(m132r$RedCorrection,m132r$GreenCorrection)
...
plot(m132g$RedCorrection,m132g$GreenCorrection)#the upper limit is for the point where de data lost linearity 
...
plot<-ggplot()+geom_jitter(data=m13all,aes(x=GreenCorrection,y=RedCorrection,color=stt),size=3)+
  ...
  xlab("EGFP signal (AU/mW)")+ylab("M13ab-signal (AU/mW)")+theme_classic()
plot
